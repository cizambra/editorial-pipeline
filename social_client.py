...
Drop-in replacement for buffer_client.py.
Publishes directly to LinkedIn and Threads via their native REST APIs.
...
# ── Compatibility shim: matches buffer_client.schedule_all_repurposed signature ──
